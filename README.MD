...
- gulp (boring tasks automatization)
  - gulp-inject (used to inject our application css/js files automatically on "index.html")
  - wiredep (used to inject our bower_components css/js files automatically)
